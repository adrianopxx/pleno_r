      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Content -->
                    ...
                    <h3 class="page-header">Consulta de Membros Inativos</h3>
          <hr>
  <?php
$foo = $_GET["indice"];
...
?>
 ...
 <div id="actions" class="row">
   <div class="col-md-12">
     <p><a href="tablesinativo.php" class="btn btn-primary">Voltar</a>
       
     
          <?php echo '<a href="certificado.php?indice='.$m; echo '" class="btn btn-primary ">Gerar Cerificado</a>'; ?>                   
     <?php echo '<a href="#?indice='.$m; echo '" class="btn btn-success" data-toggle="modal" data-target="#deletemodal">Reativar</a></p> ';
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Reativar Membro? </h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">Pressione SIM Para Reativar.</div>
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">NÃO</button>
            <?php echo '<a class="btn btn-success" href="reativar.php?indice='.$m; echo '" class="btn btn-primary ">SIM</a>'; ?>
