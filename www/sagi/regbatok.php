...
$batismo= $_POST["entrada"];
$nome = $_POST["nome"];
$local = $_POST["local"];
$oficiante = $_POST["oficiante"];

//ano,codigo da operação (01 -ca,02-cb,03-co),dia,mes,numero de ordem

//ECHO now(y);

$sqlinsert = "INSERT INTO certbat(dataentrada,nome,local,oficiante) VALUES ('$batismo','$nome','$local','$oficiante')";
...
<p style="font-weight:bold;">GRAVADO COM SUCESSO!!!</p>
        ...
        <div class="card-body">
         ...
         <div class="text-center">
          <a class="btn btn-success" href="registrobatismo.php">EMITIR CERTIFICADO</a>
