...
$query = mysqli_query($conecta,"SELECT * FROM cadastro where  nome LIKE '$pesquisa' and ativo=0 ORDER BY matricula ") or die( mysqli_error($conecta));
...
$m=$aux["matricula"];
echo '<td class="actions">';echo '<a class="btn btn-primary btn-xs" href="view_inativo.php?indice='.$m; echo'">Visualizar </a>';
