        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Digite sua matricula e sua senha para entrar</p>
                  </div>

                  <form class="row g-3 needs-validation" action="valida_login.php" method="POST">

                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Matricula</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="text" name="usuario" class="form-control" id="yourUsername" required>
                        <div class="invalid-feedback">Por favor digite sua matricula!</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      <label for="validationDefault04" class="form-label">Local</label>
                    <select class="form-select" id="validationDefault04" name ="unidade" required="">
                    <option selected="MATRIZ" value="MATRIZ">MATRIZ</option>
              ...
              <div class="credits">
                               Sistema gerencial da <a href="#">Iadpg</a>
              </div>
